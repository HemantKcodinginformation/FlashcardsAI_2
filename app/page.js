    ...
    <Container maxWidth="100vw">
      ...
      <Box sx={{ my: 6, textAlign: "center" }}>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            <Box sx={{ p: 3, border: "1px solid", borderColor: "grey.300", borderRadius: 2 }}>
              <Typography variant="h5" gutterBottom> 2 Middle Level Plan </Typography>
              <Typography variant="h6" gutterBottom> 15$ / Month </Typography>
              <Typography gutterBottom> The Middle Tier plan costs 15 dollars per month, gives user access to making their own flashcards, more storage, a 300,000 requests to AI to
                generate flashcards for the user. </Typography>
              <Button variant="contained" color="primary" sx={{ mt: 2 }}> Choose Middle Plan </Button>
            </Box>
          </Grid>
          <Grid item xs={12} md={4}>
            <Box sx={{ p: 3, border: "1px solid", borderColor: "grey.300", borderRadius: 2 }}>
              <Typography variant="h5" gutterBottom> 3 Pro High Level Plan </Typography>
              <Typography variant="h6" gutterBottom> 90$ / Month </Typography>
              ...
              <Button variant="contained" color="primary" sx={{ mt: 2 }}> Choose Pro High Plan </Button>
            </Box>
          </Grid>
        </Grid>
      </Box>
